...
//R+
static char ruy_shp_gamma_d1[] = {
	0xD1, 0x00, 0x04, 0x00,	0x0D, 0x00, 0x1E, 0x00,
	0x2F, 0x00, 0x40, 0x00,	0x5E, 0x00, 0x78, 0x00,
	0xA2
};
static char ruy_shp_gamma_d2[] = {
	0xD2, 0x00, 0xC4, 0x00,	0xF1, 0x01, 0x17, 0x01,
	0x4E, 0x01, 0x74, 0x01,	0x75, 0x01, 0x96, 0x01,
	0xB3
};
static char ruy_shp_gamma_d3[] = {
	0xD3, 0x01, 0xC2, 0x01,	0xD7, 0x01, 0xE8, 0x01,
	0xFB, 0x02, 0x14, 0x02,	0x2F, 0x02, 0x41, 0x02,
	0x74
};
static char ruy_shp_gamma_d4[] = {
	0xD4, 0x02, 0x97, 0x02,	0x99
};
//G+
static char ruy_shp_gamma_d5[] = {
	0xD5, 0x00, 0x5F, 0x00,	0x66, 0x00, 0x74, 0x00,
	0x81, 0x00, 0x8D, 0x00,	0xA2, 0x00, 0xB4, 0x00,
	0xD2
};
static char ruy_shp_gamma_d6[] = {
	0xD6, 0x00, 0xEA, 0x01,	0x11, 0x01, 0x30, 0x01,
	0x5E, 0x01, 0x80, 0x01,	0x80, 0x01, 0x9D, 0x01,
	0xB7
};
static char ruy_shp_gamma_d7[] = {
	0xD7, 0x01, 0xC7, 0x01,	0xDA, 0x01, 0xE9, 0x01,
	0xFC, 0x02, 0x16, 0x02,	0x2F, 0x02, 0x44, 0x02,
	0x5B
};
static char ruy_shp_gamma_d8[] = {
	0xD8, 0x02, 0x95, 0x02,	0x99
};
//B+
static char ruy_shp_gamma_d9[] = {
	0xD9, 0x00, 0x5F, 0x00,	0x68, 0x00, 0x7C, 0x00,
	0x8A, 0x00, 0x96, 0x00,	0xAD, 0x00, 0xC0, 0x00,
	0xDE
};
static char ruy_shp_gamma_dd[] = {
	0xDD, 0x00, 0xF6, 0x01,	0x1D, 0x01, 0x39, 0x01,
	0x62, 0x01, 0x84, 0x01,	0x85, 0x01, 0xA0, 0x01,
	0xB8
};
static char ruy_shp_gamma_de[] = {
	0xDE, 0x01, 0xC8, 0x01,	0xDB, 0x01, 0xE7, 0x01,
	0xFF, 0x02, 0x15, 0x02,	0x39, 0x02, 0x5C, 0x02,
	0x8B
};
static char ruy_shp_gamma_df[] = {
	0xDF, 0x02, 0x98, 0x02,	0x99
};
//R-
static char ruy_shp_gamma_e0[] = {
	0xE0, 0x00, 0x02, 0x00,	0x0E, 0x00, 0x24, 0x00,
	0x3B, 0x00, 0x50, 0x00,	0x78, 0x00, 0x9B, 0x00,
	0xD4
};
static char ruy_shp_gamma_e1[] = {
	0xE1, 0x01, 0x02, 0x01,	0x42, 0x01, 0x78, 0x01,
	0xCB, 0x02, 0x08, 0x02,	0x09, 0x02, 0x41, 0x02,
	0x79
};
static char ruy_shp_gamma_e2[] = {
	0xE2, 0x02, 0x9A, 0x02,	0xC8, 0x02, 0xEF, 0x03,
	0x1E, 0x03, 0x49, 0x03,	0x6C, 0x03, 0x82, 0x03,
	0xBC
};
static char ruy_shp_gamma_e3[] = {
	0xE3, 0x03, 0xEB, 0x03,	0xEE
};
//G-
static char ruy_shp_gamma_e4[] = {
	0xE4, 0x00, 0x79, 0x00,	0x83, 0x00, 0x96, 0x00,
	0xA8, 0x00, 0xB8, 0x00,	0xD5, 0x00, 0xED, 0x01,
	0x16
};
static char ruy_shp_gamma_e5[] = {
	0xE5, 0x01, 0x38, 0x01,	0x70, 0x01, 0x9E, 0x01,
	0xE4, 0x02, 0x1A, 0x02,	0x1C, 0x02, 0x4F, 0x02,
	0x83
};
static char ruy_shp_gamma_e6[] = {
	0xE6, 0x02, 0xA3, 0x02,	0xCE, 0x02, 0xF3, 0x03,
	0x20, 0x03, 0x4C, 0x03,	0x6C, 0x03, 0x86, 0x03,
	0xA0
};
static char ruy_shp_gamma_e7[] = {
	0xE7, 0x03, 0xE8, 0x03, 0xEE
};
//B-
static char ruy_shp_gamma_e8[] = {
	0xE8, 0x00, 0x79, 0x00,	0x86, 0x00, 0xA0, 0x00,
	0xB3, 0x00, 0xC3, 0x00,	0xE4, 0x00, 0xFE, 0x01,
	0x27
};
static char ruy_shp_gamma_e9[] = {
	0xE9, 0x01, 0x49, 0x01,	0x81, 0x01, 0xAC, 0x01,
	0xEA, 0x02, 0x22, 0x02,	0x23, 0x02, 0x54, 0x02,
	0x84
};
static char ruy_shp_gamma_ea[] = {
	0xEA, 0x02, 0xA5, 0x02,	0xD0, 0x02, 0xEC, 0x03,
	0x25, 0x03, 0x49, 0x03,	0x79, 0x03, 0xA1, 0x03,
	0xDA
};
static char ruy_shp_gamma_eb[] = {
	0xEB, 0x03, 0xEC, 0x03,	0xEE
};
...
static struct dsi_cmd_desc ruy_shp_cmd_on_cmds[] = {
	...
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,
		4, (char[]){0xBB, 0x63, 0x03, 0x63}},/* vertical noise*/

	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,
		2, (char[]){0xBB, 0x22}},/* source driver */
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,
	...
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, (char[]){0xC7, 0x12}},

	//enter gamma table
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_d1), ruy_shp_gamma_d1},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_d2), ruy_shp_gamma_d2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_d3), ruy_shp_gamma_d3},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_d4), ruy_shp_gamma_d4},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_d5), ruy_shp_gamma_d5},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_d6), ruy_shp_gamma_d6},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_d7), ruy_shp_gamma_d7},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_d8), ruy_shp_gamma_d8},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_d9), ruy_shp_gamma_d9},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_dd), ruy_shp_gamma_dd},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_de), ruy_shp_gamma_de},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_df), ruy_shp_gamma_df},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_e0), ruy_shp_gamma_e0},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_e1), ruy_shp_gamma_e1},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_e2), ruy_shp_gamma_e2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_e3), ruy_shp_gamma_e3},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_e4), ruy_shp_gamma_e4},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_e5), ruy_shp_gamma_e5},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_e6), ruy_shp_gamma_e6},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_e7), ruy_shp_gamma_e7},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_e8), ruy_shp_gamma_e8},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_e9), ruy_shp_gamma_e9},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_ea), ruy_shp_gamma_ea},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, ARRAY_SIZE(ruy_shp_gamma_eb), ruy_shp_gamma_eb},
	//leave gamma table
