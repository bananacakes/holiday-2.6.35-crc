...
#define WLC_E_RELOAD		84
#define WLC_E_RSSI_LOW		85      /* Send up rssi low event */
#define WLC_E_ASSOCREQ_IE	86	/* Send up assoc ie */
//HTC_CSP_START
#define WLC_E_LOAD_IND		87
//HTC_CSP_END
#define WLC_E_LAST		88
